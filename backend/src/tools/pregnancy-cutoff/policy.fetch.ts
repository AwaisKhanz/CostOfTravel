import type { PregnancyPolicy } from './types.js';

const mockPolicies: Record<string, PregnancyPolicy> = {
  delta: {
    maxWeeksSingle: 36,
    maxWeeksMultiple: 32,
...
export function fetchPolicy(carrier: string): PregnancyPolicy | null {
