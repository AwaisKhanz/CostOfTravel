import type { Scenario, Jurisdiction, TwentyFourHourOutput } from './types.js';

export function calculateOutput(scenario: Scenario, jurisdiction: Jurisdiction): TwentyFourHourOutput {
