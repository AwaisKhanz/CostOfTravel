import type { TwentyFourHourInput, Scenario, Jurisdiction } from './types.js';
import { getJurisdictionForAirport } from './geography.js';

export function mapScenario(input: TwentyFourHourInput, nowUTC: Date): { scenario: Scenario, jurisdiction: Jurisdiction } {
