      ...
      <div className="max-w-xl mx-auto py-12">
        {isLoading && step === 0 ? (
          <div className="flex flex-col items-center justify-center min-h-[40vh]">
             ...
             <p className="mt-4 font-black text-foreground/20 tracking-[0.3em] text-[10px] uppercase">loading_scenarios...</p>
          </div>
        ) : (
          <>
            {step < 99 && (
            ...
            {step === 99 && calculating ? (
               <div className="bg-card p-12 rounded-card border border-border-subtle shadow-premium text-center">
                  ...
                  <h2 className="text-2xl font-extrabold text-foreground tracking-tight animate-pulse mb-4">Analyzing Carrier Rules...</h2>
                  <p className="text-xs text-foreground/40 font-black uppercase tracking-widest">Running deterministic scenario mapping...</p>
               </div>
            ) : result ? (
